...
const SearchConfigPanel: React.FC<SearchConfigPanelProps> = ({ config, onChange }) => {
  ...
  return (
    <div className="settings-subgrid settings-subgrid--flat">
      <div className="settings-block settings-block--sub">
        <div className="settings-block__head"><h3>基础召回</h3><span>范围</span></div>
